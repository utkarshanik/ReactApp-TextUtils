...
{/* 
  <a className="navbar-brand" href="#">{props.title}</a> */}
   ...
   <div className="collapse navbar-collapse" id="navbarSupportedContent">
     <ul className="navbar-nav me-auto mb-2 mb-lg-0">
       ...
       <li className="nav-item">
       <Link className="nav-link active" to="/about">{props.a} </Link>
         {/* <a className="nav-link active" href="about">{props.a} </a> */}
       </li>
     </ul>
  ...
  <label className="form-check-label" htmlFor="flexSwitchCheckDefault"   >{props.mo}</label>
</div>
...
// to use javascript in html should use '{}' for eg {props.title}
//props (properties)  used to pass the data between component iin unidirection flow p=>c
// proptypes sets dataTypes to props
// default props are used when one cant pass the value using props soo in output default props will be displayed 
// .isRequired  used where value cant be null i.e it should pass something 